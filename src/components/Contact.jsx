...
const Contact = ({data}) => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_elj6hjq', 'template_dg9e19p', formRef.current, 'oupLHLuMkbTYTZZN-')
      .then(
        (result) => {
    ...
    >
      ...
      <div className="formContainer">
        ...
        >
          ...
          <textarea rows={8} placeholder="Message" name="message" value={massage} onChange={(e)=>setMassage(e.target.value)}/>
